...
public class DerbyUtil {
	...
	private Embedded typeEmbedded = Embedded.MEMORY;
	 ...
	 * @throws Exception
	 */
	public DerbyUtil(String host, int port, String dbName) throws Exception {
		createNetwork(host, port, dbName);
	}
	 ...
	 * @throws Exception
	 */
	public DerbyUtil(String dbName, Embedded typeEmbedded) throws Exception {
		createEmbedded(dbName, typeEmbedded);
	}
	
	private void createNetwork(String host, int port, String dbName) throws Exception {
	...
	private void createEmbedded(String dbName, Embedded typeEmbedded) throws Exception {
	 ...
	 */
	public void executeScript(String resourcePath) throws UnsupportedEncodingException {
