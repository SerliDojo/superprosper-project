...
public class Main {
	...
	public static void main(String[] args) {
		...
		Agent a = new Agent("CONSEI", "DOM2", "THOM", "quake@wares.org");
		Client c = new Client("Pascal2", "MERON", "0505050505", "PT-CH");
		Prospect p = new Prospect(new Date(), c, a);
		Contrat t = new Contrat("Tél illimité", c, new Date(), new Date());
