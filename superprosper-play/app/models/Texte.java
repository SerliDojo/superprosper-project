...
public class Texte extends GenericModel {
	...
	public static String lireTexte(String categorie, String code) {
		return lireTexte(categorie, code, Lang.getLocale().getLanguage());
	}
	
	public static String lireTexte(String categorie, String code, String langue) {
		Texte texteId = new Texte();
		texteId.setCategorie(categorie);
		texteId.setCode(code);
		texteId.setLangue(langue.toUpperCase());

		Texte texte = em().find(Texte.class, texteId);
